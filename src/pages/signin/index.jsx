...
const Signin = () => {
    ...
    return (
        <>
            <div className="absolute z-10 top-[-171px] left-[-90px] sm:w-[473px] sm:h-[473px] w-[130%] h-[550px]  bg-[#ff2f80] pl-4 flex py-2 -mb-10 md:py-4 gap-2 items-center rounded-full"></div>
            ...
            <div className="text-white text-[14px] font-normal z-20 mb-12">
            ...
            <div className="text-[14px] font-normal">Or enther with email</div>
            <input
                type="text"
